Итоговая работа по курсу "Системный администратор" SYS-22 Концевой Н.Ю.
...
1.3 Группы безопасности для ограничения доступности хостов по определенным портам
  - balancer-sg (nginx1-2 разрешен доступ чере збалансировщик на порты 22, 80, 10051)
  - zabbix-sg  (разрешен доступ на порты 22, 8080, 10050)
  - elastic-sg (разрешен доступ на порты 22, 10051, 9200)
  - kibana-sg (разрешен доступ на порты 22, 10051, 5601)
